...
static const char qt_meta_stringdata_registerForm[] = {
    "registerForm\0"
};
...
const QMetaObjectExtraData registerForm::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject registerForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_registerForm,
      qt_meta_data_registerForm, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &registerForm::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_registerForm))
