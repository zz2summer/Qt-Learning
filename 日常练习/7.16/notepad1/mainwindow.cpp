    ...
    ui(new Ui::MainWindow)
{
 ...
 //   QObject::connect(ui->aboutMeAction,SIGNAL(clicked()),this,SLOT(aboudMeSlot()));
...
/*
void MainWindow::aboudMeSlot()
{
    about *aboutUs = new about;
    aboutUs->setWindowTitle(tr("关于我自己！"));
    aboutUs->show();
}
*/
void MainWindow::on_aboutMeAction_triggered()
{
    about *aboutUs = new about;
    aboutUs->setWindowTitle(tr("关于我自己！"));
    aboutUs->show();
